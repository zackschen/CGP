    ...
    if not os.path.isdir('./data/Five_data/binary_mixture_5_Data/'):
        ...
        for n,idx in enumerate(idata):
                ...
                for s in ['train','test']:
                    ...
                    for image,target in loader:
                        ...
                        if s == 'train':
                            ...
                            data[n][s]['saug'].append(stong_image)
            ...
            for s in ['train','test']:
                ...
                if s == 'train':
                    data[n][s]['saug']=torch.stack(data[n][s]['saug']).view(-1,size[0],size[1],size[2])
                ...
                if s == 'train':
                    torch.save(data[n][s]['saug'], os.path.join(os.path.expanduser('./data/Five_data/binary_mixture_5_Data'),'data'+str(idx)+s+'saug.bin'))
        ...
        for n,idx in enumerate(idata):
            ...
            for s in ['train','test']:
                ...
                if s == 'train':
                    data[n][s]['saug'] = torch.load(os.path.join(os.path.expanduser('./data/Five_data/binary_mixture_5_Data'),'data'+str(idx)+s+'saug.bin'))
